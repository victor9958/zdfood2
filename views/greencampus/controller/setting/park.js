    ...
    $(function () {
        var setting = {
            ...
            async: {
                enable: true,
                type: 'get',
                url: setter.baseUrl + '/site/park/child',
                autoParam: ["id"]
            },
            edit: {
                drag: {
        ...
        function onRename(event, treeId, treeNode, isCancel) {
            admin.req({
                url: setter.baseUrl + '/site/' + parentId + '/park'
                , type: 'put'
                , data: {'name': new_name}
                , done: function (res) {
        ...
        function beforeDrop(treeId, treeNodes, targetNode, moveType, isCopy) {
            ...
            layer.confirm(msg, function (index) {
                ...
                admin.req({
                    url: setter.baseUrl + '/site/park/drag'
                    , type: 'put'
        ...
        $(document).on('click', '#confirm_park', function () {
            ...
            if (!excelPath) {
                ...
                admin.req({
                    url: setter.baseUrl + '/site/park/import-excel' //实际使用请改成服务端真实接口
                    , type: 'post'

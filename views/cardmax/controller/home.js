layui.define(function (exports) {
    ...
    layui.use(['echarts', 'form', 'table', 'laydate'], function () {
        ...
        var echartsApp = [], options = []/*, options = [
            // 网点使用订单统计
            {
                // color: ['#67E0E3'],
                tooltip: {
                ...
                xAxis: [
                    {
                        ...
                        data: ['网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '网点一号', '电费缴费', '洗衣支付', '充电支付'],
                    }
                ],
                yAxis: [
                    {
        ...
        laydate.render({
            ...
            , done: function (value, date, endDate) {
                var timeArr = value.split('至');
                query.beginDate = timeArr[0];
                query.endDate = timeArr[1];
                dataBar(query);
                dataPie(query);
            }
        });
        ...
        table.render({
            id: 'index_repair'
            , elem: '#index_repair'
            , url: setter.baseUrl + '/graph/repair-synopsis' //模拟接口
            , page: false
            , cellMinWidth: 80
            , loading: false
            , limit: setter.limit
            ...
            , cols: [[
                {
                    ...
                    , templet: function (d) {
                        if (d.device_title) {
                            return '【' + d.device_title + '】' + d.content
                        } else {
                            return '【其他】' + d.content
                        }
                    }
                ...
                , {
                    field: 'created_at', title: '提交时间', width: 110
                    , templet: function (d) {
        ...
        function dataBar(data) {
            ...
            admin.req({
                url: setter.baseUrl + '/graph/orders'
                , type: 'get'
                , data: data
                , done: function (res) {
                    var unit;
        ...
        function dataPie(data) {
            admin.req({
                url: setter.baseUrl + '/graph/pay-type'
                , type: 'get'
                , data: data
                , done: function (res) {
        ...
        form.on('select(countType)', function (data) {
            ...
            query.countType = data.value;
            dataBar(query);
        });

        form.on('select(operator)', function (data) {
            operatorId = data.value;
            query.operatorId = data.value;
            dataBar(query);
            dataPie({operatorId:operatorId});
        });
